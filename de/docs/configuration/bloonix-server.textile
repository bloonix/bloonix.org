...
|Parameter|Standard|Beschreibung|
|command||Das Kommando, um eine SMS zu versenden.|
...
|subject|<notextile>*** STATUS %s FOR %h (%a) ***</notextile>|Hier wird der Betreff konfiguriert. Die Strings __%s__ (Status), __%h__ (Hostname) und __%a__ (IP-Adresse) werden ersetzt.|
...
|Parameter|Standard|Beschreibung|
|sms_to||Die Mobilfunknummer, zu der die Nachricht umgeleitet werden soll.|
|mail_to||Die E-Mail-Adresse, zu der die Nachricht umgeleitet werden soll.|
