...
p. Bloonix ist ein plugin-basiertes Monitoring-System und verfügt unter anderem über Plugins zur Überwachung von Linux, Windows, Apache, Nginx, Varnish, Memcached, Redis, MySQL und PostgreSQL. Die Plugins werden stetig weiterentwickelt. Eine grobe Übersicht der zur Verfügung stehende Plugins finden Sie hier: "Bloonix-Plugins":/docs/components#plugins
