...
p. _Bitte beachten Sie,_ dass die Plugins immer auf dem Server installiert werden müssen, auf oder von dem Sie die Komponenten überwachen möchten.

h1. Verfügbare Plugins

|bloonix-plugins-apache|Plugins Überwachung des Apache Webservers.|
|bloonix-plugins-base|Basis Plugins zur Überwachung von Server Diensten über HTTP, TCP, UDP, SMTP, IMAP, POP3,<br/>DNS, FTP, if-Statistiken von Rountern, Switches und ein Wrapper zum Einsatz von Nagios-Checks.|
...
pre. bloonix-load-plugins --load-all
