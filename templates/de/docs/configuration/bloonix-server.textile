...
<% include /de/docs/configuration/template-tcp-server-server.textile %>
...
| failover_command | | Mit __failover_command__ lässt sich ein weiteres Kommando einrichten, welches aufgerufen wird, wenn das erste Kommando fehlgeschlagen ist. |
