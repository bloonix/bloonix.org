...
p. *Hinweiß:* Falls ein selbst-signiertes Zertifikat im für den Bloonix-Server konfiguriert ist, müssen die SSL-Parameter __ssl_verify_peer__ auf __none__ setzen, da der Agent ansonsten einen Fehler liefert bei der Prüfung des Server-Zertifikats.
