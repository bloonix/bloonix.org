...
bc. # Debian 6:
echo "deb https://download.bloonix.de/repos/debian/ squeeze main" >>/etc/apt/sources.list

bc. # Debian 7:
echo "deb https://download.bloonix.de/repos/debian/ wheezy main" >>/etc/apt/sources.list

bc. # Debian 8:
echo "deb https://download.bloonix.de/repos/debian/ jessie main" >>/etc/apt/sources.list

bc. # Ubuntu 12.04:
echo "deb https://download.bloonix.de/repos/ubuntu/ precise main" >>/etc/apt/sources.list

bc. # Ubuntu 14.04:
echo "deb https://download.bloonix.de/repos/ubuntu/ trusty main" >>/etc/apt/sources.list
...
bc. # RHEL 6:
rpm -ivh https://download.bloonix.de/repos/centos/6/noarch/bloonix-release-0.5-1.el6.noarch.rpm

bc. # RHEL 7:
rpm -ivh https://download.bloonix.de/repos/centos/7/noarch/bloonix-release-0.5-1.el7.centos.noarch.rpm
