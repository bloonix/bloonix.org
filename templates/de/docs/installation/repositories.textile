...
bc. wget https://download.bloonix.de/repos/debian/bloonix.gpg -O- | apt-key add -

p. Jetzt muss nur noch das passende Bloonix Repository in __/etc/apt/sources.list__ eingetragen werden:

bc. Debian 6: echo "deb https://download.bloonix.de/repos/debian/ squeeze main" >>/etc/apt/sources.list
...
bc. Ubuntu 12.04: echo "deb https://download.bloonix.de/repos/ubuntu/ precise main" >>/etc/apt/sources.list
...
bc. RHEL 6: rpm -ivh https://download.bloonix.de/repos/centos/6/noarch/bloonix-release-0.5-1.el6.noarch.rpm
...
bc. cat <<EOT >/etc/yum.repos.d/Bloonix.repo
[bloonix]
...
bc. wget https://download.bloonix.de/repos/centos/RPM-GPG-KEY-Bloonix --output-document /etc/pki/rpm-gpg/RPM-GPG-KEY-Bloonix
...
bc. rpm -ivh https://download.bloonix.de/repos/suse/13/noarch/bloonix-release-0.4-1.noarch.rpm
