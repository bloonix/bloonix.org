...
p. _*Bitte beachten Sie*_, dass der Benutzer __admin__ nur verwendet werden sollte, um im Bereich __ADMINISTRATION__ zu agieren. Bitte erstellen Sie als aller erstes eine eigene Company, eine eigene Gruppe und einen eigenen Benutzer. Der Benutzer und die Gruppe müssen der neuen Company zugeordnet werden und der Benutzer sollte Operator-Rechte haben.
