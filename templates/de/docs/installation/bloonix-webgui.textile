...
p. *Auch wichtig:* Falls Sie mal das Passwort vergessen, so können Sie das Skript __/srv/bloonix/webgui/bin/generate-password__ verwenden, um ein neues Passwort zu generieren. Das Skript gibt zwei Update-Statements aus, die auf der Datenbank von Bloonix ausgeführt werden müssen.
