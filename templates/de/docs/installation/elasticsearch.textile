...
p. _Wichtiger Hinweis:_  Es ist nicht möglich, von Elasticsearch Version 1.x auf Version 2.x upzugraden, da das alte Bloonix Mapping nicht kompatible zu Elasticsearch 2.x ist! Sie können Elasticsearch 2.x installieren, wenn es eine neue Installation ist.
