...
p. Natürlich ist die Empfehlung, mit den Hardwarekomponenten nicht sparsam zu sein. Beispielsweise wird der Preisunterschied von SSDs zu 15krpm SAS Platten immer geringer. Statt 4 x 15krpm Platten in einem RAID 10 einzusetzen, könnte man auch 2 SSD Platten in einem RAID 1 einsetzen. Es ist aber auch möglich, Bloonix auf einer kleinern virutellen Maschine zu betreiben, wenn Sie nur ein paar wenige Hosts und Services überwachen möchten.
