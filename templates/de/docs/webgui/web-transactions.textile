...
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-1.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-2.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-3.png!

h3. 2. Gebe den Wert __mein@benutzer.test__ in das Formularfeld __username__ ein

!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-4.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-5.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-6.png!

h3. 3. Gebe den Wert __geheim__ in das Formularfeld __password__ ein

!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-7.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-8.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-9.png!

h3. 4. Klicke auf den Button mit der ID __#submit__

!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-10.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-11.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-12.png!

h3. 5. Warte bis das Element __#content__ geladen ist

!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-13.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-14.png!
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-15.png!

h3. Nun klicken Sie auf den Button __Check it!__, um den Workflow zu testen.

!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-16.png!
...
!{width: 100%; margin: 40px 0;}/public/img/wtrm-step-17.png!
