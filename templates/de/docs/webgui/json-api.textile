...
bc. https://demo.bloonix.de/hosts
...
bc. https://demo.bloonix.de/hosts?pretty
...
bc. curl -H 'Content-Type: application/json' https://demo.bloonix.de/login/ -d '
{
    "username" : "username",
    "password" : "password"
}'
...
bc.. curl -H 'Content-Type: application/json' https://demo.bloonix.de/token/csrf -d '
{
    "sid" : "sid"
}'

curl -H 'Content-Type: application/json' https://demo.bloonix.de/hosts/create-downtime/ -d '
{
    "sid" : "sid",
    "token" : "token",
    "host_id" : [60, 62, 96],
...
curl -H 'Content-Type: application/json' https://demo.bloonix.de/hosts/delete-downtime/ -d '
{
    "sid" : "sid",
    "token" : "token",
    "host_id" : [60, 62, 96],
