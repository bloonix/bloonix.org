...
p. Mit dem Notification Screen haben Sie die Möglichkeit, die für einen Benutzer konfigurierten Hosts mit einem Status zu sehen. Diese Übersicht eignet sich besonders für große Wandmonitore in Ihrem Büro. Dort haben Sie dann zu jeder Zeit den Status Ihrer Hosts und Services im Blickfeld und können deutlich schneller reagieren, wenn etwas ausfällt.

!/public/img/docs/notification-screen-1.png!
...
* Wenn der Benutzer zu Gruppen hinzugefügt wird, dann ohne die Berechtigung Services anzulegen, zu ändern oder zu löschen können
...
!/public/img/docs/authentificaton-key-1.png

p. Mit dieser Einstellung können Sie den Notification Screen nun wie folgt aufrufen:

bc. https://gui.bloonix.de/screen/?username=test@bloonix.de;authkey=yOH1doaktzMjrMza69JcQwxrfKeRGP
...
!/public/img/docs/chart-view-selection-1.png!
...
bc. https://gui.bloonix.de/screen/charts/?username=test@bloonix.de;authkey=yOH1doaktzMjrMza69JcQwxrfKeRGP;id=21
