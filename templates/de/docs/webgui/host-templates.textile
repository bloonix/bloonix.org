...
!/public/img/docs/add-host-templates-1.png!
...
!/public/img/docs/host-template-click-menu-1.png!
...
!/public/img/docs/manage-host-template-services-1.png!
...
!/public/img/docs/add-host-template-to-host-1.png!
...
!/public/img/docs/manage-host-template-of-host-1.png!
...
p. Es ist möglich, Variablen für Hosts und Host-Templates einzurichten. Diese Variablen können zur Definition von Schwellwerten eingesetzt werden. Auf diese Weise bekommen Sie ein Stück Dynamik trotz der starren Host-Templates zurück. Weitere Informationen hierzu finden Sie im Dokument: <a data-id="host-variables">%%site.help.doc.host-variables%%</a>
...
p. *Bitte beachten Sie,* dass es möglich ist, Variablen für Hosts und Host-Templates einzurichten. Diese Variablen können zur Definition von Schwellwerten eingesetzt werden. Auf diese Weise bekommen Sie ein Stück Dynamik trotz der starren Host-Templates zurück. Weitere Informationen hierzu finden Sie im Dokument: <a data-id="host-variables">%%site.help.doc.host-variables%%</a>

p. In der Übersicht der konfigurierten Service-Checks eines Hosts lassen sich Service-Checks, die aus einem Host-Template vererbt wurden, auch sehr leicht erkennen. In der folgenden Grafik sind diese Service-Checks mit dem Icon !/public/img/docs/host-template-icon.png! markiert.

!/public/img/docs/host-template-services-view-1.png! 
