...
p. Es ist möglich, Variablen für Hosts und Host-Templates einzurichten. Diese Variablen können zur Definition von Schwellwerten eingesetzt werden. Auf diese Weise bekommen Sie ein Stück Dynamik trotz der starren Host-Templates zurück. Weitere Informationen hierzu finden Sie im Dokument: <a data-id="host-variables">Host Variablen</a>
...
p. *Bitte beachten Sie,* dass es möglich ist, Variablen für Hosts und Host-Templates einzurichten. Diese Variablen können zur Definition von Schwellwerten eingesetzt werden. Auf diese Weise bekommen Sie ein Stück Dynamik trotz der starren Host-Templates zurück. Weitere Informationen hierzu finden Sie im Dokument: <a data-id="host-variables">Host Variablen</a>
