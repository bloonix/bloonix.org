...
p. Die Variablen __IPADDR__, __IPADDR6__ und __HOSTNAME__ werden durch die IP-Adressen und den Hostnamen des Hosts ersetzt. Die Variable __RND__ wird durch einen Random String ersetzt mit einer Länger, welcher __num__ entspricht. Der Random String enthält nur die folgenden Zeichen: __a-zA-Z_0-9__
