...
* Jeder Absatz sollte mit einem Textile Schlüsselwort beginnen.
...
Dies ist ein Text, der automatisch in ein Paragraph <p> eingebetter wird.
</pre>

<pre>
bc.. h1. Titel

p. Besser ist es, wenn der Paragraph auch wirklich mit <i>p.</p> eingeleitet wird.
</pre>
