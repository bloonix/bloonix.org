...
!(full-width-shadow)/public/img/bloonix-location-configuration.png!

!(full-width-shadow)/public/img/bloonix-locations.png!
...
!(full-width-shadow)/public/img/bloonix-configure-location-check.png!
