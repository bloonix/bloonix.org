...
p. Bitte beachten Sie unbedingt die Sicherheitshinweise bei der Einrichtung von Agenten und Satelliten, die remote Checks ausführen: "Sicherheit":/de/docs/about/security.html#remote-checks-über-einen-agenten-oder-satellit
