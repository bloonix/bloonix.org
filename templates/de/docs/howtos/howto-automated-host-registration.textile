...
p. Legen Sie die Konfiguraionsdatei __/etc/bloonix/agent/register.conf__ mit folgendem Inhalt an:

bc. webgui_url https://your-webgui.test/
data {
    company_id 12345
...
!{margin: 40px 0;}/public/img/bloonix-company-authkey1.png!
...
!{margin: 40px 0;}/public/img/bloonix-process-reg-hosts.png!
...
bc. curl 'https://your-webgui.test/register/host' -d '{
    "company_id": "12345",
