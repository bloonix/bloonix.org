...
p. All you need to do is to include the file into the Nginx configuration. Edit the configuration of Nginx:

bc. /etc/nginx/nginx.conf

p. and insert the following line _at the end of the http section_:
