...
p. Nagios-Plugins are not compatible, nevertheless, there is the possibility to use Nagios-Plugins about a Wrapper of Bloonix. The status can be questioned therefore by services. Hence, we recommend to use only Nagios-Plugins if there is still no suitable Plugin for the monitoring of the desired service.
