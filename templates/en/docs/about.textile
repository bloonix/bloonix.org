...
p. Nagios plugins are compatible and can be used with a Wrapper of Bloonix. Hence, we recommend to use only Nagios plugins if there is still no suitable Bloonix plugin for the monitoring of the desired service.
