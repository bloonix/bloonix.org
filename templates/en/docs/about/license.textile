...
h2. Special license for the WebGUI
...
p. For the visual representation of statistics Bloonix uses various JavaScript libraries. For the free variation the libraries Flot and JQVMap are used. These Libraries stand under the MIT licence and permit therefore a commercial use. For further details to the libraries read the following document: "LICENSE-WEBGUI":https://download.bloonix.de/LICENSE-WEBGUI

h2. License for Highcharts and Highmaps
